...
export default defineConfig({
  ...
  outDirTemplate: 'moodle-ai-grader-{{browser}}',
  ...
  manifestVersion: 3,
  manifest: {
    name: 'Moodle AI Grader',
    version: '3.1.0',
    description:
      'Erwartungshorizont und Antwortvorlage in der Frage anlegen, Klausuren mit KI-Unterstützung bewerten und Punkte samt Feedback eintragen.',
    permissions: ['storage'],
    action: { default_title: 'Moodle AI Grader' },
    browser_specific_settings: {
      gecko: {
        id: 'moodle-ai-grader@spielhoff.de',
