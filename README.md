...
| **Moodle AI Coach** · [Quelltext](moodle-ai-coach/) | 1.5.0 | **[⬇ ZIP](https://github.com/arfhh/moodle-chrome-erweiterungen/raw/main/dist/moodle-ai-coach.zip)** | **Kurze Freitextantworten** (2–3 Sätze): liest den Erwartungshorizont aus der Frage, bewertet und gibt Sprachfeedback |
...
> **Der Coach ist jung (1.5.0).** Der Bewertungsweg ist einmal vollständig mit
